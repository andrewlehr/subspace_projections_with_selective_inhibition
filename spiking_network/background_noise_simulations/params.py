...
neuron_params = {
    ...
    'sigma_gwn' : 200 * pA,     # std of stochastic background current #100
...
synapse_params = {
    ...
    'g' :  8, #6,                   # ratio of recurrent inhibition and excitation
    'sigma_e' : 0.075,    #0.075      # excitatory connectivity width
    'sigma_i' : 0.1,   #.1         # inhibitory connectivity width
